...
const ErrorDisplay = ({ message }) => (
    <div className="flex flex-col items-center justify-center min-h-[50vh] text-center p-6">
        ...
        <Link to="/my-orders" className="bg-stone-900 text-white px-8 py-3 text-xs font-bold uppercase tracking-widest rounded-sm hover:bg-teal-700 transition-colors">
            Back to Orders
        </Link>
    </div>
);
                    ...
                    >
                        ...
                        <header className="mb-10">
                            <Link 
                                ...
                                className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-stone-500 hover:text-teal-700 mb-6 transition-colors"
                            >
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                <div className="bg-white p-6 md:p-8 rounded-sm border border-stone-100 shadow-sm">
                                    <h2 className="font-marcellus text-xl text-stone-900 mb-6 flex items-center gap-3">
                                        {/* Changed icon color to Teal */}
                                        <ShoppingBag size={20} className="text-teal-700" /> Items in this Order
                                    </h2>
                                    ...
                                    <div className="mt-8 pt-6 border-t border-stone-100 bg-stone-50/50 -mx-6 -mb-6 p-6 rounded-b-sm">
                                        <div className="space-y-2 text-sm text-stone-600 max-w-xs ml-auto">
                                            ...
                                            <div className="flex justify-between border-t border-stone-200 pt-3 mt-3">
                                                ...
                                                <span className="font-bold text-2xl text-stone-900">₹{Number(order.totalPrice || 0).toFixed(2)}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <aside className="space-y-6">
                                ...
                                <InfoCard icon={CreditCard} title="Payment Details">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {/* Changed pending color to Teal/Amber */}
                                        <span className={`px-2 py-1 text-[10px] font-bold uppercase tracking-widest rounded-sm ${order.isPaid ? 'bg-green-100 text-green-800' : 'bg-teal-100 text-teal-800'}`}>
                                            {order.isPaid ? 'Paid' : 'Verifying'}
                                        </span>
                                    </div>
