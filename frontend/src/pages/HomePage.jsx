...
const newArrivals = [
  ...
  { _id: '68b17e5d843fba334ca74778', name: 'MacBook Air M1', price: '52,000', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyKCKGmF5c8Ab9Zar9h-RGFkVG20HHdp7ytA&s' },
    ...
    <div className="HomePageWrapper bg-[#FDFBF7] text-stone-800 font-montserrat overflow-x-hidden">
      ...
      <div className="relative pt-20 pb-20 px-4 overflow-hidden" data-aos="fade-up">
        ...
        <div className="container mx-auto text-center max-w-4xl relative z-10 flex flex-col items-center">
          ...
          <form onSubmit={handleSearch} className="w-full max-w-2xl mx-auto mb-10 relative shadow-xl shadow-teal-900/5 rounded-full bg-white">
            <input
              type="text"
              value={keyword}
            ...
            />
            <button type="submit" className="absolute right-2 top-2 bottom-2 bg-stone-900 text-white px-8 rounded-full text-sm font-bold uppercase tracking-widest hover:bg-teal-700 transition-colors">
              Search
            </button>
          </form>
