...
import { 
    ...
    ShieldCheck,
    Truck,
    CheckCircle // Replaced Package with CheckCircle
} from 'lucide-react';
...
const EmptyCart = () => (
    ...
    >
        ...
        <p className="text-stone-500 mb-8 max-w-md font-light">
            Looks like you haven't added any unique finds to your cart yet.
        </p>
        <Link 
            to="/products" 
            // Changed button color to Teal
            className="bg-stone-900 text-white px-8 py-3 text-xs font-bold uppercase tracking-widest hover:bg-teal-700 transition-colors flex items-center gap-2"
        >
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <section className="bg-white p-6 md:p-8 rounded-sm shadow-sm border border-stone-100">
                        <div className="flex items-center justify-between mb-6 pb-4 border-b border-stone-100">
                            <h2 className="font-marcellus text-xl text-stone-900 flex items-center gap-2">
                                ...
                                <MapPin size={20} className="text-teal-700" /> Delivery Address
                            </h2>
                            <Link to="/my-addresses" className="text-xs font-bold uppercase tracking-widest text-stone-500 hover:text-teal-700 transition-colors">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {address.map((addr) => (
                                    <div 
                                        ...
                                        // Changed selected border color to Teal
                                        className={`relative p-4 border rounded-sm cursor-pointer transition-all duration-300 ${selectedAddress?._id === addr._id ? 'border-teal-700 bg-teal-50/20' : 'border-stone-200 hover:border-stone-400'}`}
                                    >
                                        {selectedAddress?._id === addr._id && (
                                            // Changed checkmark color to Teal
                    ...
                    <section className="bg-white p-6 md:p-8 rounded-sm shadow-sm border border-stone-100">
                        <h2 className="font-marcellus text-xl text-stone-900 mb-6 flex items-center gap-2 pb-4 border-b border-stone-100">
                            {/* Changed icon color to Teal */}
                            <ShoppingBag size={20} className="text-teal-700" /> Order Items ({cartItems.length})
                        </h2>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex flex-col justify-between py-1">
                                            <div>
                                                ...
                                                {/* Condition Description instead of Customizations for Marketplace */}
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-28">
                        <div className="bg-white p-6 md:p-8 rounded-sm shadow-xl border border-stone-100 relative overflow-hidden">
                            {/* Decorative background element - Changed to Teal */}
                            <div className="absolute -top-10 -right-10 w-32 h-32 bg-teal-50 rounded-full blur-3xl pointer-events-none"></div>

                            <h2 className="font-marcellus text-xl text-stone-900 mb-6 flex items-center gap-2 relative z-10">
                                {/* Changed icon color to Teal */}
                                <CreditCard size={20} className="text-teal-700" /> Payment Summary
                            </h2>
                            ...
                            <div className="space-y-3 mb-6 text-sm text-stone-600 relative z-10">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-teal-700 font-bold text-xs uppercase tracking-widest">Free</span>
                                </div>
                            ...
                            <div className="bg-stone-50 p-3 mb-6 rounded-sm text-xs text-stone-500 flex items-start gap-2">
                                ...
                                <p>Secure Checkout. Your payment information is held in escrow until item verification.</p>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full bg-stone-900 text-white py-4 px-6 text-xs font-bold uppercase tracking-[0.15em] hover:bg-teal-700 transition-all duration-300 disabled:bg-stone-300 disabled:cursor-not-allowed shadow-lg shadow-stone-900/10 flex items-center justify-center gap-2 relative z-10"
                            >
                                {isPlacingOrder ? (
                                    <>
