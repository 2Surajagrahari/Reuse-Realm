...
const AmbientBackground = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-teal-900/10 rounded-full blur-[120px]"></div>
    ...
    <div className="relative min-h-screen w-full bg-[#FDFBF7] font-montserrat text-stone-800 flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h2 className="font-marcellus text-2xl text-stone-800 mb-2">Join the Community</h2>
          <p className="text-stone-500 text-sm font-light">Create an account to start buying and selling.</p>
        </div>
        ...
        <form onSubmit={submitHandler} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            // Changed hover background to Teal
            className="w-full bg-stone-900 text-white font-bold py-4 px-6 hover:bg-teal-700 transition-all duration-300 text-xs uppercase tracking-[0.2em] rounded-sm disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-stone-900/20 mt-8"
          >
